...
export default function Footer() {
  return (
    <>
        <footer className="flex flex-col bg-mainColor items-center justify-around w-full py-16 text-sm text-gray-800/70">
            <div className="flex items-center gap-8">
                <Link to={'/'} className="font-medium text-gray-500 hover:text-black transition-all">
                    Home
                </Link>
                <Link to={'/products'} className="font-medium text-gray-500 hover:text-black transition-all">
                    Products
                </Link>
