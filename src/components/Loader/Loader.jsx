    ...
    return (
        <>
            ...
            <div className="preloader__text">
                <p className="preloader__msg text-secondaryColor"><span className='font-semibold text-secondaryColor'>Allvero</span> is loading..</p>
                <p className="preloader__msg preloader__msg--last text-secondaryColor">This is taking long. Something’s wrong.</p>
            </div>
            </div>
        </>
    )
